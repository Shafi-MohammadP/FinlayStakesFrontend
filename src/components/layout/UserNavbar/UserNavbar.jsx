  ...
  return (
    <div>
      <div className="bg-white w-svw shadow-md pb-4">
        <div className="flex justify-between gap-2">
          <div className="flex flex-col pl-1 pt-[1.2%] 2xl:gap-[10%] xl:gap-[8%] lg:gap-[6%] md:gap-[5%] 2xl:flex-row xl:flex-row lg:flex-row md:flex-row">
            <div className="flex gap-10 sm:gap-24 md:gap-2 justify-between md:justify-normal md:pl-3 pl-1">
              <img
                onClick={() => setModal(!modal)}
                src={menubaricon}
                alt="menubar"
                className="w-9 h-9 mt-3 block md:hidden  hover:cursor-pointer hover:bg-black hover:bg-opacity-10 p-2 rounded-lg"
              />
              <img src={logo} alt="Logo" className="w-[13rem]  md:w-[15rem]" />
              <img
                onClick={HandleSidebar}
                src={menubaricon}
                alt="menubar"
                className="w-9 h-9 mt-3 hidden md:block  hover:cursor-pointer hover:bg-black hover:bg-opacity-10 p-2 rounded-lg"
              />
              <img
                onClick={() => setOpens(!isOpen)}
                src={menubaricon}
                alt="menubar"
                className="w-9 h-9 mt-3 block md:hidden  hover:cursor-pointer hover:bg-black hover:bg-opacity-10 p-2 rounded-lg"
              />
                ...
                <div className="flex h-11 pt-1 w-auto">
                  <div>
                    <input
                      type="search"
                      placeholder="Search ..."
                      className="pl-3 h-10 bg-[#6560F0] bg-opacity-15 rounded-l-full focus:outline-none rounded-r-none p-1 2xl:w-80 xl:w-64 lg:w-56 md:w-44"
                    />
                  </div>
                ...
                <div className="flex gap-5 ">
                  <div className="w-11 h-11 border-[1px] border-[#c1c1c1] rounded-full">
                    <img
                      src={UKflag}
                      alt="logo"
                      className="rounded-full opacity-90 hover:opacity-100 hover:cursor-pointer"
                    />
                  </div>
              ...
              <div className="flex h-11 pt-1 w-auto">
                <div>
                  <input
                    type="search"
                    placeholder="Search ..."
                    className="pl-3 h-10 bg-[#6560F0] bg-opacity-15 rounded-l-full focus:outline-none rounded-r-none p-1 2xl:w-80 xl:w-64 lg:w-56 md:w-36 "
                  />
                </div>
                <div className=" flex justify-center items-center bg-[#6560F0] rounded-r-full rounded-l-none w-16 hover:cursor-pointer hover:bg-[#7194ff] ">
                  <FontAwesomeIcon
      ...
      <div className="flex flex-col 2xl:flex-row xl:flex-row lg:flex-row md:flex-row bg-[#6560F0] bg-opacity-10 w-full h-full">
        <div
          className={isModal ? "sidebar-container show" : "sidebar-container"}
        >
          {isModal ? (
            <>
              <UserSidebar />
